...
**Program:** AICTE OIB-SIP October Cohort  
**GitHub:** [bilalmlkdev](https://github.com/bilalmlkdev)  
**LinkedIn:** [bilalmlkdev](https://linkedin.com/in/bilalmlkdev)  
**Internship window:** 5 Oct 2026 - 15 Nov 2026  

> Completing **all three levels** (8 projects) for a full portfolio pass.  
> Minimum requirement is one complete level - this repo goes further.
...
|---|---------|--------|-------------|--------|
| 1 | Pizza Delivery App | [WebDev-L3-PizzaDelivery](./WebDev-L3-PizzaDelivery) | - | ⬜ |

**Stack:** React / Node/Express / MongoDB / Razorpay (test mode)  
**Warning:** Requires full-stack + DB knowledge - build after L1/L2.

---

## How each task is delivered

- Folder name format: `OIBSIP/WebDev-L{level}-{ProjectName}/`
- Source code + `README.md` + `screenshots/` (screenshots embedded in each task README)
- Demo video: **2s title card** (Name / Track / Task) then live walkthrough
- LinkedIn post per task with `#oasisinfobyte`
- Submitted via official form (opens **25 Oct 2026**)
